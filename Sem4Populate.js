    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, Movie.findById(movie._id).populate('actor')];
                case 4:
                    populateMovie = _a.sent();
                    console.log(populateMovie);
                    console.log('La Pelicula', populateMovie.name, 'tiene de actor a', populateMovie.actor.name);
                    return [2 /*return*/];
            }
        });
    });
